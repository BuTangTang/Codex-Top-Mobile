export const RPC_METHODS = {
  ...
  DAEMON_DIRECT_SESSION_SEND: 'daemon.directSessions.send',
  DAEMON_DIRECT_SESSION_CONTROL_READ: 'daemon.directSessions.control.read',
  DAEMON_DIRECT_SESSION_CONTROL_ACTION: 'daemon.directSessions.control.action',
  DAEMON_DIRECT_SESSIONS_PROJECTS_LIST: 'daemon.directSessions.projects.list',
...
const SOCKET_RPC_SESSION_WRITE_AUTHORIZATION_METHODS = new Set<string>([
  ...
  RPC_METHODS.DAEMON_DIRECT_SESSION_CONTROL_READ,
  RPC_METHODS.DAEMON_DIRECT_SESSION_CONTROL_ACTION,
