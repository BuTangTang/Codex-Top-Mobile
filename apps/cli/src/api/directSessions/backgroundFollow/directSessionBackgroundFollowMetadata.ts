  ...
  return {
    ...
    directSessionV1: {
      ...
      followPolicyV1: buildDirectSessionFollowPolicyV1({
        ...
        generation: currentPolicy === params.policy && typeof currentFollowPolicy?.generation === 'string'
          ? currentFollowPolicy.generation : params.generation,
      }),
...
export async function updateSessionMetadataWithDirectSessionFollowPolicy(params: Readonly<{
  ...
  return updateSessionMetadataWithRetry({
    token: params.token,
