export type ActivityNotificationEvent = (
  | Readonly<{ topic: 'session_failed'; sessionId: string; sessionTitle?: string | null }>
  | Readonly<{
    topic: 'ready';
    sessionId: string;
  ...
  | Readonly<{
    ...
    providerLimitId?: string | null;
    action?: Readonly<{ kind: 'open_url'; url: string }> | null;
  }>) & Readonly<{ directSession?: { eventKey: string; turnId: string; machineId: string; accountId?: string; notificationIdentity?: string } }>;
