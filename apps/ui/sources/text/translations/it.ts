...
export const it: TranslationStructure = {
  ...
  bugReports: {
    ...
    settings: {
      ...
      openSourceMaterials: "Materiali del progetto open source",
      accountAndConnection: "Account e connessione",
    ...
    aboutFooter:
      "Codex Top si basa sul progetto open source Happier.",
    whatsNew: "Novità",
  ...
  newSession: {
      launchSettings: "Impostazioni di avvio",
  ...
  phonePasswordLogin: {
      ...
      invalidCredentials: "Account o password errati, oppure accesso non disponibile.",
      rateLimited: "Troppi tentativi. Riprova più tardi.",
      unavailable: "Accesso non riuscito. Controlla il server e riprova.",
  },
  sessionsList: {
      statusAwaitingConfirmation: "In attesa di conferma",
    serverHeader: ({ server }: { server: string }) => `Server: ${server}`,
    storagePersistedTab: "Sessioni cloud",
    storageDirectTab: "Sessioni sul computer",
  ...
  directSessions: {
    ...
    historyUnavailable: "La cronologia della sessione è temporaneamente non disponibile. I messaggi già caricati vengono conservati.",
    historyAvailabilityUnknown: "La fonte attuale non ha ancora indicato se la cronologia della sessione è disponibile.",
        followNotifications: "Segui le notifiche dell’attività",
        unfollowNotifications: "Non seguire più le notifiche dell’attività",
        followUpdateFailed: "Impossibile aggiornare le notifiche. Controlla la connessione e riprova.",
        observation: {
            running: "In esecuzione",
            needs_input: "Risposta richiesta",
    ...
    browseActivityUnknown: "Sconosciuta",
        ...
        browseSearchIncomplete: "La ricerca non ha incluso tutte le sessioni; potrebbero esserci altri risultati corrispondenti. Prova una ricerca più specifica.",
...
settingsSession: {
  ...
  settingsLanguage: {
        saveFailed: "Impossibile salvare la lingua. Riprova.",
  ...
  welcome: {
    ...
    welcomeQuestionBody: "Codex Top è il centro di controllo dei tuoi agenti di codifica IA. Nessuna email richiesta. Il tuo account è una chiave privata, generata su questo dispositivo.",

    welcomePrimaryButton: "Prima volta qui — iniziamo",
    welcomePrimarySubtitle: "Un tocco. Niente moduli. La tua chiave vive qui.",

    welcomeSecondaryButton: "Accedi — uso già Codex Top",
    ...
    brandHeroGetStarted: "Inizia",
      ...
      sessionGettingStarted: {
          phoneTitle: "Nessun computer connesso",
          phoneSubtitle: "Stiamo migliorando la connessione ai computer. Dopo la connessione, le sessioni appariranno qui.",
  ...
  chatFooter: {
    ...
    directSessionDesktopReady: "Puoi inviare testo direttamente a questa sessione desktop. Verranno usati il modello e le autorizzazioni attuali del desktop.",
    directSessionDesktopUnknown: "Non è possibile confermare se questa sessione desktop può ricevere testo. Controlla la connessione e riprova.",
    directSessionDesktopUnavailable: "L’invio di testo a questa sessione desktop non è disponibile. Controlla la sessione desktop e la connessione, poi riprova.",
    directSessionDesktopDisconnected: "La sessione desktop non è connessa. Apri questa sessione nell’app desktop e riprova.",
    directSessionDesktopUnsupported: "Questa app desktop o piattaforma non supporta l’invio di testo da qui. Verifica la disponibilità di una versione desktop compatibile.",
    directSessionDraftKept: "Il messaggio non è stato inviato. La bozza è stata conservata.",
