...
const mcpServersUxTranslationExtension = {
  ...
  /** 按当前语言生成 Codex Top 文案，并保留传入的动态信息。 */
  mcpServersHeroSubtitle: ({ configuredCount }: { configuredCount: number }) => `在 Codex Top 中已配置 ${configuredCount} 个`,
  mcpServersHeroSubtitleEmpty: '只需创建一次服务器，预览它们适用的位置，并导入其他工具已经在使用的配置。',
  mcpServersSegmentConfigured: '已配置',
  mcpServersSegmentConfiguredSubtitle: '你的 Codex Top 目录',
  ...
  mcpServersPreviewRefreshSubtitle: '为此上下文解析 Codex Top 和提供方原生 MCP 服务器',
  ...
  mcpServersBuiltInDescription: '在 Codex Top 会话中始终可用。',
  mcpServersSourceHappier: 'Codex Top',
  ...
  mcpServersEditorAppliesToSubtitle: '选择 Codex Top 默认应将此服务器添加到哪里。',
  ...
  mcpServersDeliveryNativeSubtitle: '此后端将 Codex Top 工具作为原生 MCP 服务器接收。',
  mcpServersDeliveryShellBridgeTitle: 'Codex Top Shell 桥接',
  mcpServersDeliveryShellBridgeSubtitle: '此后端通过 `happier tools` 桥接调用 Codex Top 工具。',
  mcpServersDeliveryUnsupportedTitle: '不支持',
  mcpServersDeliveryUnsupportedSubtitle: '此后端当前不接收 Codex Top 工具。',
} as const;
...
const newSessionMcpTranslationExtension = {
  ...
  mcpDetectedUnsupportedSubtitle: '更新此机器上的 Codex Top 以启用提供商配置扫描。',
  mcpHappierSectionTitle: 'Codex Top MCP 服务器',
  mcpHappierEmptyTitle: 'Codex Top 中未定义 MCP 服务器',
...
const settingsAppearanceTranslationExtension = {
  themeProfiles: {
    ...
    defaultThemeSubtitle: 'Use Codex Top theme colors without a custom profile',
    active: '沿用原主题',
    ...
    importProfileSubtitle: 'Paste JSON or choose a Codex Top theme profile file',
    ...
    previewStatus: 'Ready',
    previewCode: 'const theme = "codex-top";',
...
const memoryEmbeddingsTranslationExtension = {
  ...
  embeddings: {
    ...
    provider: {
      ...
      options: {
        localTitle: '本地模型',
        localSubtitle: '由 Codex Top 管理，并在首次使用时下载',
...
const promptLibraryUxRefinementTranslationExtension = {
  zhHans: {
    ...
    externalAssetsInstallMethodSymlinkSubtitle: '将目标链接到 Codex Top 管理的副本，便于后续更新',
    ...
    registriesItemImportSubtitle: '将此技能包导入 Codex Top 资料库',
...
const sessionHandoffTranslationExtensions = {
  'zh-Hans': {
    activeWarning: {
      title: '此会话仍在此设备上运行',
      message: '开始移交前，Codex Top 会先在这台设备上停止此会话，然后再将其转移到所选设备。',
      confirm: '在此停止并移交',
    },
    progress: {
      title: '正在移交会话',
    ...
    recovery: {
      ...
      messageAfterSourceStop:
        'Codex Top 已经在这台设备上停止了此会话，但未能在目标设备上完成启动。你可以在这里重新启动，或在恢复目标设备期间保持其停止状态。',
...
const settingsSessionHandoffTranslationExtensions = {
  'zh-Hans': {
    ...
    directTargetMode: {
      ...
      convertToPersistedTitle: '转换为 Codex Top',
      convertToPersistedSubtitle: '导入会话记录，并作为 Codex Top 会话继续。',
    },
  },
} as const;
...
export const zhHans: TranslationStructure = {
    codexTopProjects: {
        ...
        all: '全部项目',
        loading: '正在读取项目…',
        unavailable: '暂无法读取桌面项目',
        offline: '电脑离线，连接后可读取项目。',
        empty: '这台电脑暂无项目',
        refresh: '刷新项目',
        openSessions: '查看该项目的会话',
        missing: '所选项目已不可访问，请重新选择。',
        selectMachine: '先选择一台电脑，再按项目筛选。',
        partial: '部分项目来源无法读取，请刷新或在电脑上检查。',
        unavailableFolder: '项目目录当前不可用',
        unknownCodex: '进入会话后核对 Codex 操作能力',
        codex: 'Codex 状态',
    },
  ...
  promptLibrary: {
    ...
    voiceStack: "语音堆栈",
    voiceStackSubtitle: "应用于 Codex Top 语音",
  ...
  appCrash: {
    title: "出错了",
    subtitle: "Codex Top 发生了意外错误。你可以重启应用界面，或复制详细信息以便支持排查。",
    detailsTitle: "错误详情",
    restart: "重启应用",
  ...
  connect: {
    ...
    scanComputerQrInstructions: "扫描电脑端 Codex Top（设置 → 添加手机）中显示的二维码。",
    scanComputerQrButton: "扫描二维码登录",
    waitingForApproval: "等待确认…",
    showQrInstead: "改为显示二维码",
    addPhoneQrInstructions: "用 Codex Top 手机应用扫描此二维码，在手机上登录。",
    ...
    externalAuthVerifiedBody: ({ provider }: { provider: string }) =>
      `我们找到了与 ${provider} 关联的现有 Codex Top 账户。要在此设备上完成登录，请使用二维码或你的密钥恢复账户密钥。`,
    restoreWithSecretKeyInstead: "改用密钥恢复",
    restoreWithSecretKeyDescription: "输入你的密钥以恢复账户访问权限。",
    lostAccessLink: "无法访问？",
    lostAccessTitle: "无法访问你的账户？",
    lostAccessBody:
      "如果你已没有任何设备与此账户关联，并且丢失了密钥，你可以通过身份提供方重置账户。这将创建一个新的 Codex Top 账户。旧的加密历史无法恢复。",
    ...
    linkNewDeviceQrInstructions: "在新设备上打开 Codex Top 并显示二维码",
  ...
  bugReports: {
    composer: {
      ...
      issueDetails: {
        ...
        reproductionStepsPlaceholder: "1. 打开 Codex Top\n2. 开始一个会话\n3. ...",
  ...
  memorySearchSettings: {
    ...
    enabled: {
      ...
      footer:
        "启用后，Codex Top 会基于已解密的对话记录在设备本地构建索引，以支持快速回忆与搜索。",
    },
    budgets: {
      groupTitle: "磁盘配额",
  ...
  subAgentGuidance: {
    ruleEditor: {
      ...
      enableInjection: {
        title: "Codex Top 运行指令",
        subtitle: "关闭后，编码代理的系统提示词中将移除原生优先路由说明和 Codex Top 运行机制。",
      },
  ...
  settings: {
    ...
    machineSetupCurrentMachineSubtitle: "直接在此设备上初始化 Codex Top",
    ...
    machineSetupStageInstall: "安装 Codex Top 并配对设备",
    ...
    machineSetupRemoteRelayRuntimeLabel: "也在远程机器上安装 服务器 运行时",
    machineSetupRemoteRelayRuntimeTitle: "远程 服务器 运行时",
    machineSetupRemoteRelayRuntimeReadyTitle: "已在远程机器上就绪",
    machineSetupRemoteRelayRuntimeReadySubtitle: "服务器 运行时已在 SSH 设置过程中安装完成。后续在该机器上进行网络配置时，请使用远程 服务器地址。",
    machineSetupRemoteRelayRuntimeUrlTitle: "远程 服务器地址",
    machineSetupRemoteRelayKeepCurrentTitle: "保留当前 服务器",
    machineSetupRemoteRelayKeepCurrentSubtitle: "保存此 服务器地址，但不切换。",
    machineSetupRemoteRelaySwitchTitle: "切换到此 服务器",
    machineSetupRemoteRelaySwitchSubtitle: "立即切换并在新的 服务器 上继续设置。",
    machineSetupRemoteRelaySwitchConfirmTitle: "切换 服务器？",
    /** 按当前语言生成 Codex Top 文案，并保留传入的动态信息。 */
    machineSetupRemoteRelaySwitchConfirmBody: ({ relayUrl }: { relayUrl: string }) =>
      `切换 Codex Top 到 ${relayUrl} 并继续设置？`,
    ...
    localRelayRuntime: {
      ...
      versionTitle: '已安装版本',
      relayUrlTitle: '本地 服务器地址',
      installOrUpdateAction: '安装或更新 服务器 运行时',
      startAction: '启动 服务器 运行时',
      stopAction: '停止 服务器 运行时',
      refreshAction: '刷新 服务器 状态',
      footer: '在连接其他设备之前，先管理这台电脑上运行的自托管 服务器。',
      progressTitle: '正在更新本地 服务器 运行时',
      progressStepInspect: '检查本地 服务器 运行时',
      progressStepHealth: '检查 服务器 健康状态',
      progressStepInstall: '安装 服务器 运行时',
      progressStepStart: '启动 服务器 运行时',
      progressStepStop: '停止 服务器 运行时',
    },
    localTailscale: {
      title: '通过 Tailscale 的私密访问',
      statusTitle: '状态',
      statusUnavailable: '请先启动本地 服务器 运行时',
      statusIdle: '尚未启用',
      ...
      progressStepServeEnable: '启用 服务器 私密访问',
    ...
    aboutFooter:
      "Codex Top 基于 Happier 开源项目开发。",
    whatsNew: "更新日志",
    whatsNewSubtitle: "查看最新更新和改进",
    reportIssue: "报告问题",
    privacyPolicy: "隐私政策",
    termsOfService: "服务条款",
    rateUs: "给 Codex Top 评分",
    ...
    servers: "服务器",
    serversSubtitle: "已保存的 服务器、分组和默认设置",
    systemStatus: "系统状态",
    ...
    machineStatus: ({
	  ...
	  systemStatus: {
	    sections: {
	      ...
	      updates: "更新",
	      appHealth: "应用与同步状态",
	      currentServer: "当前 服务器",
      identity: "已登录身份",
      configuredServers: "已配置 服务器",
      machinesActiveServer: "机器（当前 服务器）",
    ...
    machine: {
      ...
      offline: "离线",
      fetchDoctorSnapshot: {
        loading: "正在获取守护进程的 服务器/账号…",
        invalid: "无法从机器读取 doctor snapshot",
      },
      daemonAttributionUnknown: "守护进程 服务器/账号：未知",
    ...
    actions: {
      runDiagnosis: "运行诊断",
      runDiagnosisSubtitle: "检测 服务器/账号/守护进程不匹配",
      refreshMachineAttribution: "刷新守护进程归属信息",
      refreshMachineAttributionSubtitle: "为部分在线机器获取守护进程 服务器/账号",
  ...
  connectedServices: {
    ...
    oauthPaste: {
      ...
      connectWebDescription:
        "打开授权 URL，在浏览器中完成 OAuth，然后将最终重定向的 URL 复制并粘贴回 Codex Top。",
    ...
    diagnostics: {
      ...
      body: {
        ...
        recovery_retry_scheduled: "Codex Top 已计划重试提供商恢复。你可以立即重试或检查已连接账号。",
        recovery_dead_lettered: "Codex Top 已耗尽自动提供商恢复重试。请检查已连接账号或重新连接所选配置文件。",
        runtime_auth_recovery_superseded: "这次提供商恢复尝试已被更新的连接服务状态取代。Codex Top 不会继续重试这个过期账号。",
        runtime_auth_generation_stale: "这次提供商恢复尝试属于较旧的连接服务代次。请等待最新切换完成，或检查已连接账号。",
        hot_apply_unavailable: "该提供商无法在正在运行的会话中安全切换身份验证。Codex Top 会等待安全重启或下一个可用的恢复路径。",
        app_server_unavailable: "提供商应用服务器无法用于验证或应用身份验证切换。请在会话准备好后重试。",
        provider_account_adoption_mismatch: "切换后提供商仍停留在其他账号。请检查已连接账号或重试切换。",
        provider_account_identity_unverified: "Codex Top 无法证明当前提供商账号身份。在获得更强证明前，它会避免向同一账号分发。",
        post_switch_verification_failed: "Codex Top 无法验证提供商是否采用了所选账号。请检查已连接账号或重试切换。",
        quota_snapshot_stale: "最新配额快照太旧，无法驱动主动切换。Codex Top 会继续使用被动恢复，直到有新的配额数据。",
        quota_fetch_disabled: "该提供商当前已禁用配额检查。Codex Top 会继续使用被动恢复。",
        quota_fetch_backoff: "收到提供商或网络响应后，配额检查暂时退避。Codex Top 稍后会重试刷新配额。",
        auth_surface_weakly_verified: "Codex Top 已验证所选身份验证文件已被重写，但该提供商不公开确切的当前账号身份。",
        connected_service_restart_requested: "Codex Top 已请求安全重启会话，以应用所选的已连接账户。",
        ...
        claude_subscription_native_auth_materialization_failed: "Codex Top 无法为此配置创建 Claude Code 原生凭据文件。请重新连接该配置，或选择账号池中的其他成员。",
    ...
    detail: {
      ...
      openGithubTokenTemplateSubtitle: "打开 GitHub，并预填 Codex Top 需要的权限",
      ...
      groupDetail: {
        ...
        softSwitchThresholdPromptBody: "输入剩余百分比，Codex Top 将在该值以下优先选择此多账号池中更安全的成员。使用 0 可关闭预防性切换。",
        ...
        staleProbePromptBody: "输入配额数据可重复使用的分钟数，超过后 Codex Top 会重新检查。",
    ...
    authModal: {
      ...
      connectedServicesSubtitle: "从 Codex Top 云获取并生成",
  ...
  settingsDesktop: {
    title: '桌面',
    footer: '控制 Codex Top 在这台电脑上的行为。',
    startOnLoginTitle: '登录时启动',
    startOnLoginSubtitle: '当你登录这台电脑时自动启动 Codex Top。',
    backgroundServiceTitle: '在后台保持可连接',
    backgroundServiceSubtitle: '关闭 Codex Top 后，这台电脑仍会继续响应。关掉之后，你的手机和浏览器在你再次打开应用之前都无法连到这台电脑。',
    backgroundServiceUnknown: '这台电脑上的 Codex Top 命令行没有报告后台服务是否在登录时启动。',
    closeStopTitle: '智能体会话仍在运行',
    closeStopBody: '关闭 Codex Top 会停止这台电脑上的后台服务，并结束在这里运行的会话。',
  ...
  settingsPets: {
    ...
    helpDocsTitle: '宠物帮助',
    helpDocsSubtitle: '打开 Codex Top 文档以查看设置和故障排除。',
    ...
    detectedCodexPetsNoTargetSubtitle: '在此电脑上启动 Codex Top，然后再次检测 Codex 宠物。',
  ...
  settingsNotifications: {
    ...
    connectedServices: {
      ...
      accountSwitch: {
        title: "账户切换",
        subtitle: "当 Codex Top 自动将提供商切换到另一个已连接账户时通知",
      },
      quotaBlocked: {
        title: "配额受阻",
    ...
    pushPriming: {
        title: '开启通知？',
        body: 'Codex Top 可以在智能体完成工作、需要权限决定或正在等待你时通知你。你随时可以在设置中更改。',
        accept: '开启',
        decline: '暂不',
        blockedTitle: '通知已被阻止',
  ...
  settingsProviders: {
    ...
    cliSourcePreference: {
      title: "CLI 来源偏好",
      subtitle: "当系统 CLI 和 Codex Top 管理安装同时存在时，选择优先使用哪一个。",
      options: {
        systemFirst: {
          title: "优先系统安装",
        ...
        managedFirst: {
          title: "优先托管安装",
          subtitle: "优先使用 Codex Top 为此提供商安装的 CLI。",
        },
      },
    },
    cliInstaller: {
    ...
    plugins: {
            claude: {
                ...
                sections: {
                    claudeModelDiscovery: {
                        title: "模型发现",
                        footer: "控制 Codex Top 是否向 Anthropic 查询所选 Claude 账户可用的模型。"
                    },
                    claudeUnifiedTerminal: {
                        title: "统一终端运行时",
                        footer: "启用后，Codex Top 会把提示发送到同一个 Claude Code 终端会话，而不是启动单独的 Agent SDK runner。"
                    },
                    claudeCodeExperiments: {
                        title: "Claude Code 实验功能",
                        footer: "这些设置同时适用于由 Codex Top 启动的 Claude 本地会话（终端）和远程会话（Agent SDK）。"
                    },
                    claudeRemoteSdk: {
                ...
                fields: {
                    claudeDynamicModelProbeEnabled: {
                        title: "发现可用模型",
                        subtitle: "允许 Codex Top 使用所选 Claude 账户查询 Anthropic。关闭后将使用 Codex Top 内置模型目录，且不会读取 Claude Code 原生凭据。"
                    },
                    ...
                    claudeUnifiedTerminalHost: {
                        title: "终端主机",
                        subtitle: "选择 Codex Top 如何托管共享的 Claude 终端会话。",
                        options: {
                            auto: {
                                title: "自动",
                            ...
                            zellij: {
                                title: "zellij",
                                subtitle: "使用 Codex Top 内置的 zellij 主机。"
                            }
                        }
                    },
                    claudeUnifiedTerminalResumeChoice: {
                        title: "大型会话恢复",
                        subtitle: "选择当 Claude 询问如何恢复大型会话时 Codex Top 的响应方式。",
                        options: {
                            ask_every_time: {
                                title: "每次询问",
                    ...
                    claudeUnifiedTerminalWorkspaceTrust: {
                        title: "工作区信任",
                        subtitle: "选择当 Claude 询问是否信任工作区时 Codex Top 的响应方式。",
                        options: {
                            ask_every_time: {
                                title: "每次询问",
                            ...
                            always_trust_happier_workspaces: {
                                title: "始终信任 Codex Top 工作区",
                                subtitle: "信任 Codex Top 打开的工作区中当前重新捕获的 Claude 提示。"
                            },
                            always_reject_happier_workspaces: {
                                title: "始终拒绝 Codex Top 工作区",
                                subtitle: "拒绝 Codex Top 打开的工作区中当前重新捕获的 Claude 提示。"
                            }
                        }
                    },
                    claudeCodeExperimentalAgentTeamsEnabled: {
                        title: "强制启用 Agent Teams",
                        subtitle: "在所有由 Codex Top 启动的 Claude 会话中启用 Claude Code 的实验性 Agent Teams（代理群）功能。"
                    },
                    claudeRemoteAgentSdkEnabled: {
                        title: "使用 Agent SDK 回退",
                        subtitle: "当统一终端运行时关闭时，通过 Agent SDK 运行由 Codex Top 控制的 Claude 会话。"
                    },
                    ...
                    claudeLocalPermissionBridgeEnabled: {
                        title: "实验性：本地权限桥接",
                        subtitle: "将 Claude 本地模式的权限请求转发到 Codex Top，以便你可以在界面中批准或拒绝。"
                    },
                    claudeLocalPermissionBridgeWaitIndefinitely: {
                        title: "保持请求打开直到回应",
                        subtitle: "启用后，Codex Top 会一直保持 Claude 本地权限请求处于待处理状态，直到你在界面中批准或拒绝。"
                    },
                    claudeLocalPermissionBridgeTimeoutSeconds: {
                        title: "可选权限超时（秒）",
                        subtitle: "仅在关闭无限等待时使用。超过该时间后，Codex Top 会回退到 Claude 的终端提示。"
                    },
            ...
            opencode: {
                ...
                sections: {
                    cliGeneration: {
                        title: "OpenCode 版本",
                        footer: "自动模式优先使用 opencode，不可用时改用 opencode2，并在启动后检测服务器 API。稳定版始终选择 opencode，但仍会检测 V1 或 V2。V2 优先使用 opencode2，否则以已选择 V2 的方式使用 opencode。Codex Top MCP 工具可通过 V2 的 ACP 模式使用；其服务器 API 暂不支持动态 MCP 注册。"
                    },
                    backendMode: {
                        title: "后端模式",
                    ...
                    server: {
                        title: "服务器连接",
                        footer: "留空即可使用 Codex Top 管理的 OpenCode 服务器生命周期。设置绝对 http(s) URL 以连接到现有 OpenCode 服务器。"
                    }
                },
                fields: {
                    opencodeCliGeneration: {
                        title: "CLI 版本",
                        subtitle: "选择 Codex Top 要启动的已安装 OpenCode 命令。",
                        options: {
            ...
            cursor: {
                ...
                sections: {
                    cli: {
                        title: "Cursor 命令行",
                        footer: "当自动检测不足时，使用指定的 Cursor 二进制文件。Codex Top 优先使用 cursor-agent，并可在启用时回退到 agent。"
                    }
                },
                fields: {
                    cursorBinaryPath: {
  ...
  settingsFeatures: {
    ...
    expChannelBridgesSubtitle: "将 Telegram 等聊天渠道连接到 Codex Top 会话（实验性）",
    ...
    expSessionsFoldersSubtitle: "用工作区文件夹整理 Codex Top 侧边栏会话",
    expPetsCompanion: "宠物",
  ...
  errors: {
    ...
    permissionCanceledSessionInactive: "会话处于非活动状态 — 无法批准此权限请求。",
      ...
      daemonUnavailableBody:
        "Codex Top 无法连接到此设备上的守护进程。它可能离线、仍在启动，或与服务器断开连接。",
      tryAgain: "请重试",
    ...
    providerAlreadyLinked: ({ provider }: { provider: string }) =>
      `${provider} 已关联到现有的 Codex Top 账号。要在此设备上登录，请从已登录的设备中将此设备进行关联。`,
  ...
  deps: {
    installNotSupported: "请更新 Codex Top CLI 以安装此依赖项。",
    installFailed: "安装失败",
    installed: "已安装",
  ...
  newSession: {
    ...
    noMachinesFound: "未找到设备。请先在您的计算机上启动 Codex Top 会话。",
    ...
    launchStillPendingBody:
      "Codex Top 尚未确认新会话。启动请求仍已保存。请重试以继续同一次启动，不会创建重复会话。",
    ...
    resume: {
      ...
      cannotApplyBody: "此恢复 ID 当前无法应用。Codex Top 将改为启动一个新会话。",
    },
    codexResumeBanner: {
      title: "Codex 恢复服务器",
    ...
    githubCliInstallModal: {
      ...
      description:
        "这会安装 GitHub CLI，以便 Codex Top 在 pull request 流程中使用你的本地 GitHub 身份验证。",
    },
  },
  ...
  session: {
    ...
    agentContinuation: {
      ...
      handedOver: {
          ...
          unavailableSource: "Codex Top 无法读取本会话的转录，因此无法重建此内容。",
          unreachable: "Codex Top 无法连接到托管本会话的机器。",
          retryAction: "重试",
      ...
      transition: {
        ...
        resumeAction: '恢复会话',
        unknown: 'Codex Top 无法确认发生了什么。请先检查此会话再重新发送。',
      },
    },
    sourceContext: {
        ...
        removeA11y: "移除来源对话",
        keepAction: "保留",
        serverMismatch: "该对话位于另一台 Codex Top 服务器上。请切换回那台服务器，或移除来源对话以重新开始。",
    },
    forking: {
      ...
      strategy: {
          ...
          replay: {
              title: "Replay 分叉",
              subtitle: "Codex Top 会重放目前的对话，作为新会话的上下文。",
          },
          configure: {
              title: "配置新会话",
	    ...
	    staleRunner: {
	      ...
	      body: "重启此会话运行器，以继续使用已更新的守护进程 CLI。Codex Top 会话本身保持不变。",
	      busyBody: "会话运行器正忙。请在当前活动结束后重试。",
	      failureBody: "Codex Top 无法重启此会话运行器。请在会话刷新后重试。",
	      identityChangedBody: "请求重启时会话运行器已发生变化。请刷新会话后重试。",
	      ineligibleBody: "此会话运行器不再符合计划重启条件。",
	      unsupportedBody: "此守护进程尚未公开会话运行器重启操作。",
	      versionUnknownBody: "Codex Top 还无法确认此运行器正在使用哪个 CLI 版本。",
	      restartAction: "重启运行器",
	    ...
	    mcpRestartRequired: {
	        ...
	        failureBody: "Codex Top 无法重启此运行器。你的 MCP 选择已保存，并会在下次启动时应用。",
	        restartAction: "重启会话",
	        restartPendingAction: "正在重启…",
	        badgeLabel: "MCP 更改",
	    ...
	    resumeSupportNoteChecking:
	      "注意：Codex Top 仍在检查此机器是否可以恢复提供方会话。",
	    resumeSupportNoteUnverified: "注意：Codex Top 无法验证此机器的恢复支持情况。",
    ...
    machineOfflineNoticeTitle: "机器离线",
      ...
      machineOfflineNoticeBody: ({ machine }: { machine: string }) =>
        `“${machine}” 处于离线状态。你现在可以将消息加入队列；机器恢复在线后，Codex Top 将继续处理。`,
    ...
    reviewFindings: {
      ...
      pendingMessages: {
        ...
        discardConfirm: {
          title: "丢弃待发送消息？",
          body: "这会保留一份已丢弃副本，并阻止 Codex Top 投递这条待发送消息。",
        },
        markHandledConfirm: {
          title: "将待发送消息标记为已处理？",
          body: "仅当提供商已处理该消息，或你不再希望 Codex Top 投递它时使用。",
        },
        dismissDeliveryConfirm: {
          title: "忽略结果不确定的投递？",
          body: "这会归档原消息，不会再次发送。如果提供商之后确认已投递，Codex Top 仍可将原消息加入对话记录。",
        },
        sendAsNewConfirm: {
          title: "将此消息作为新消息发送？",
        ...
        errors: {
          ...
          clearTerminalComposerUnsupported: "此会话不支持从 Codex Top 清空终端输入框。",
  ...
  server: {
    ...
    serverConfiguration: "服务器 设置",
    enterServerUrl: "请输入 服务器地址",
    notValidHappyServer: "不是有效的 Codex Top 服务器",
    changeServer: "更改 服务器",
    continueWithServer: "继续使用此 服务器？",
    resetToDefault: "重置为默认",
    resetServerDefault: "重置 服务器 为默认值？",
    validating: "验证中...",
    validatingServer: "正在验证 服务器...",
    serverReturnedError: "服务器 返回错误",
    failedToConnectToServer: "连接 服务器 失败",
    currentlyUsingCustomServer: "当前使用自定义 服务器",
    customServerUrlLabel: "自定义 服务器地址",
    advancedFeatureFooter:
      "这是一个高级功能。只有在您知道自己在做什么时才更改 服务器。更改 服务器 后您需要重新登录。",
    useThisServer: "使用此 服务器",
    autoConfigHint:
      "如果您自行托管：请先配置 服务器，然后登录（或创建账户），再连接您的终端。",
    renameServer: "重命名 服务器",
    renameServerPrompt: "请输入此 服务器 的新名称。",
    renameServerGroup: "重命名 服务器 组",
    renameServerGroupPrompt: "请输入此 服务器 组的新名称。",
    serverNamePlaceholder: "服务器 名称",
    cannotRenameCloud: "无法重命名云 服务器。",
    removeServer: "移除 服务器",
    removeServerConfirm: ({ name }: { name: string }) =>
      `从已保存的 服务器 中移除“${name}”？`,
    removeServerGroup: "移除 服务器 组",
    removeServerGroupConfirm: ({ name }: { name: string }) =>
      `从已保存的 服务器 组中移除“${name}”？`,
    cannotRemoveCloud: "无法移除云 服务器。",
    signOutThisServer: "同时从此 服务器 退出登录？",
    signOutThisServerPrompt:
      "在此设备上找到了此 服务器 的已保存凭据。",
    savedServersTitle: "已保存的 服务器",
    signedIn: "已登录",
    signedOut: "未登录",
    authStatusUnknown: "认证状态未知",
    switchToServer: "切换到此 服务器",
    active: "当前",
    default: "默认",
    addServerTitle: "添加 服务器",
    switchForThisTab: "仅为此标签页切换",
    makeDefaultOnDevice: "设为此设备默认",
    serverNameLabel: "服务器 名称",
    addAndUse: "添加并使用",
    addTargetsTitle: "添加",
    addServerSubtitle: "添加新 服务器 并切换到它",
    notificationAddServerHint: "此 服务器 尚未在此设备上保存。请在下方添加以继续。",
    serverCount: ({ count }: { count: number }) => `${count} 个 服务器`,
    useCanonicalServerUrlTitle: "使用 服务器 的规范 URL？",
    useCanonicalServerUrlBody:
      "该 服务器 提供了一个应可在其他设备上使用的规范 URL。要用它替代你输入的那个吗？",
    insecureHttpUrlTitle: "不安全的 服务器地址",
    insecureHttpUrlBody:
      "此地址使用 HTTP。跨网络连接请使用 HTTPS。仍要继续吗？",
    signedOutSwitchConfirmTitle: "未连接",
    signedOutSwitchConfirmBody:
      "切换到此 服务器 并返回主页，以便登录或创建账户？",
    addServerGroupTitle: "添加 服务器 组",
    addServerGroupSubtitle: "创建可复用的 服务器 组",
    serverGroupNameLabel: "组名称",
    serverGroupNamePlaceholder: "我的 服务器 组",
    serverGroupServersLabel: "服务器",
    saveServerGroup: "保存组",
    serverGroupMustHaveServer: "服务器 组至少需要包含一个 服务器。",
    relayDrift: {
  ...
  phonePasswordLogin: {
      ...
      login: "登录",
      server: "服务器设置",
      invalidCredentials: "账号或密码不正确，或账号暂不可用。",
      rateLimited: "尝试次数过多，请稍后重试。",
      unavailable: "登录失败，请检查服务器后重试。",
  },
  sessionsList: {
      statusAwaitingConfirmation: "待确认",
    serverHeader: ({ server }: { server: string }) => `服务器：${server}`,
    storagePersistedTab: "云端会话",
    storageDirectTab: "电脑会话",
    ...
    moveToWorkspaceRoot: '工作区根目录',
        ...
        /** 生成会话操作提示，保留名称、操作和数量参数的原值。 */
        moveSheetTitle: ({ item }: { item: string }) => `移动“${item}”`,
        moveSheetDestinationLabel: '目标位置',
        moveSheetSubmit: '移动',
        moveSheetSearchPlaceholder: '搜索文件夹…',
        moveSheetEmpty: '暂无可用目标位置',
        moveSheetDestinations: '目标位置',
        moveSheetDisabledDescendant: '不能移入自身或其子文件夹。',
        moveSheetDisabledMaxDepth: '这将超出文件夹层级限制。',
        moveSheetDisabledCurrent: '已在此位置。',
        moveSheetDisabledUnavailable: '此目标位置不可用。',
        dragHandleA11yLabel: '拖动手柄',
        /** 生成会话操作提示，保留名称、操作和数量参数的原值。 */
        dragA11yPickedUp: ({ item }: { item: string }) => `已选中“${item}”，可以移动。`,
        /** 生成会话操作提示，保留名称、操作和数量参数的原值。 */
        dragA11yDroppedReorder: ({ item, destination }: { item: string; destination: string }) => `已将“${item}”移至“${destination}”附近。`,
        /** 生成会话操作提示，保留名称、操作和数量参数的原值。 */
        dragA11yDroppedNest: ({ item, destination }: { item: string; destination: string }) => `已将“${item}”移入“${destination}”。`,
        /** 生成会话操作提示，保留名称、操作和数量参数的原值。 */
        dragA11yDroppedRoot: ({ item, destination }: { item: string; destination: string }) => `已将“${item}”移至“${destination}”。`,
        /** 生成会话操作提示，保留名称、操作和数量参数的原值。 */
        dragA11yCancelled: ({ item }: { item: string }) => `已取消移动“${item}”。`,
        /** 生成会话操作提示，保留名称、操作和数量参数的原值。 */
        dragA11yBlocked: ({ item, reason }: { item: string; reason: string }) => `无法移动“${item}”：${reason}`,
        dragA11yBlockedDescendantCycle: '目标位于正在移动的文件夹内',
        dragA11yBlockedLeafCannotBeParent: '会话内不能包含其他项目',
        dragA11yBlockedMaxDepth: '已达到文件夹层级限制',
        dragA11yBlockedSamePosition: '已在该位置',
        dragA11yBlockedWorkspaceScope: '目标位于另一个工作区',
        dragA11yBlockedNoTarget: '尚未选择目标位置',
        dragA11yBlockedDirectSession: '直连会话不能移入文件夹',
        dragA11yBlockedFeatureDisabled: '尚未启用会话文件夹',
        ...
        /** 生成会话操作提示，保留名称、操作和数量参数的原值。 */
        selectionConfirm: ({ action, count }: { action: string; count: number }) => `要对所选的 ${count} 个会话执行“${action}”吗？`,
        /** 生成会话操作提示，保留名称、操作和数量参数的原值。 */
        selectionConfirmA11yLabel: ({ action }: { action: string }) => `确认${action}`,
        /** 生成会话操作提示，保留名称、操作和数量参数的原值。 */
        selectionMoveSheetSourceLabel: ({ count }: { count: number }) => `已选择 ${count} 个会话`,
        orderingMode: {
            title: '会话顺序',
  ...
  directSessions: {
    ...
    browseListChanged: "会话列表已更新，请刷新后继续加载。",
    browseListIncomplete: "当前列表尚未覆盖全部会话，可能还有其他会话。请稍后刷新重试。",
    historyPreviewOnly: "当前仅能读取预览，无法读取完整会话历史。",
    historyUnavailable: "暂时无法读取会话历史，已加载的消息仍保留。",
    historyAvailabilityUnknown: "当前来源尚未提供历史记录的可用状态。",
    followNotifications: "关注任务通知",
    unfollowNotifications: "取消任务通知",
    followUpdateFailed: "无法更新任务通知，请检查连接后重试。",
    observation: {
        running: "运行中",
        needs_input: "等待处理",
        completed: "已完成",
    ...
    browseActivityUnknown: "未知",
        ...
        browseSearchIncomplete: "搜索尚未覆盖全部会话，可能还有匹配结果。请缩小搜索范围后重试。",
    ...
    stopSessionControlUnavailable: "Codex Top 无法连接会话控制。请确认会话所在机器和守护进程在线，然后重试。",
    archiveSession: "归档会话",
    ...
    locationLabel: "位置",
    checkoutLabel: "检出",
    happySessionIdCopied: "Codex Top 会话 ID 已复制到剪贴板",
    failedToCopySessionId: "复制 Codex Top 会话 ID 失败",
    happySessionId: "Codex Top 会话 ID",
  ...
  workflowActivityView: {
    ...
    acpHistoryImport: {
      title: "导入会话历史记录？",
      defaultNote:
        "此会话历史记录与 Codex Top 中已有内容不同。导入可能会产生重复项。",
      counts: {
  ...
  files: {
    ...
    branchMenu: {
      ...
      indexLock: {
        title: "移除过期的 Git 锁？",
        body: "Git 报告存在索引锁。如果没有其他 Git 命令正在运行，Codex Top 可以移除这个过期锁并重试。",
        confirm: "移除锁并重试",
    ...
    stagedChanges: ({ count }: { count: number }) => `已暂存的更改 (${count})`,
      ...
      fileEditingUnsupported:
        "连接的守护进程不支持文件编辑。请在该机器上更新 Codex Top 以启用写入操作。",
    ...
    sourceControlOperations: {
      ...
      update: {
        ...
        pullRequests: {
          ...
          featureBranchPromptBody: "Codex Top 会先检出此分支再继续。",
  ...
  executionRuns: {
    ...
    details: {
      ...
      launchOrigin: {
        ...
        externalAction: "通过 Codex Top 操作从外部启动",
      ...
      settingsActions: {
        ...
        spawnPolicy: {
            title: "AI 会话创建策略",
            footer: "这些控制项仅在 Codex Top 会话内的助手创建另一个会话时生效。继承自父会话的设置仍会被允许；被拒绝的项目会用清晰错误拒绝显式覆盖。",
            toggles: {
        ...
        targets: {
            ...
            session_agent: {
                title: 'AI 会话',
                subtitle: '控制在 Codex Top 会话内运行的助手可用的工具。',
            },
            mcp: {
                title: 'MCP',
                subtitle: '控制使用 Codex Top MCP 操作目录的外部 MCP 客户端。',
            },
            cli: {
                title: '会话控制 CLI',
...
settingsSession: {
    ...
    inputBehavior: {
      ...
      windows: {
        ...
        windowNamePlaceholder: 'codex-top',
    ...
    messageSending: {
      ...
      inactiveResumePolicySubtitle: "选择向非活动会话发送消息后 Codex Top 应执行的操作。",
      ...
      nonSteerablePromptFooter: '权限模式更改以及 /clear 或 /compact 无法在回合中途生效。选择智能体忙碌时 Codex Top 如何处理此类消息。',
      nonSteerablePrompt: {
        askTitle: '每次询问',
    ...
    usageLimitRecovery: {
      title: "使用限制恢复",
      footer:
        "选择当提供方要求等待后才能继续时 Codex Top 的处理方式。",
      modeTitle: "达到使用限制时",
      askTitle: "每次询问",
    ...
    sessionCreation: {
      ...
      wizardPresentationDropdownSubtitle: "显示一个可打开完整选择器的紧凑行。",
          ...
          promptPersonalization: {
              ...
              footer: 'Choose which built-in instructions Codex Top adds to new agent sessions. This does not hide options an agent already sends.',
    ...
    defaultPermissions: {
      ...
      applyPermissionChangesNextPromptSubtitle: "仅在下一条消息时应用。",
          ...
          defaultStorage: {
              title: '默认会话类型',
              footer: '选择新会话默认是作为 Codex Top 会话启动，还是作为直接由提供方支持的会话启动。',
              globalTitle: '全局默认',
              persistedSubtitle: '默认将新会话存储在 Codex Top 中，并在设备之间同步。',
  ...
  settingsVoice: {
    ...
    modeTitle: "语音",
    modeDescription:
      "配置语音功能。您可以完全关闭语音、使用 Codex Top 语音（需要订阅），或使用您自己的 ElevenLabs 账号。",
    mode: {
      off: "关闭",
      offSubtitle: "关闭所有语音功能",
      happier: "Codex Top 语音",
      happierSubtitle: "使用 Codex Top 语音（需要订阅）",
      local: "本地 OSS 语音",
    ...
    byo: {
      ...
      autoprovCreate: "创建 Codex Top 代理",
      autoprovCreateSubtitle:
        "使用您的 API 密钥在 ElevenLabs 账号中创建并配置 Codex Top 代理",
      autoprovUpdate: "更新代理",
      autoprovUpdateSubtitle: "将您的代理更新到最新的 Codex Top 模板",
    ...
    local: {
      ...
      kokoro: {
        ...
        manifest: {
          title: "模型包清单",
          subtitle:
            "默认使用 Codex Top 模型包（可通过 EXPO_PUBLIC_HAPPIER_MODEL_PACK_MANIFESTS 覆盖）。",
          detailResolved: "已解析",
          detailMissing: "缺失",
        },
        assetPack: {
      ...
      conversation: {
        ...
        backend: {
          daemonSubtitle: "使用 Codex Top 后端并支持提供方续接。",
        ...
        resumability: {
          ...
          disabledVoiceAgent: "需要 Codex Top 语音助手。",
      ...
      mediatorBackendSubtitle: "Daemon（使用 Codex Top 后端）或 OpenAI 兼容 HTTP",
      ...
      testTtsSample: "你好，这里是 Codex Top。这是你本地 TTS 的测试。",
    ...
    onboardingShowcase: {
                ...
                "cards": {
                    "welcome": {
                        ...
                        "existingBody": "任何在你机器上运行的 Claude、Codex 或 OpenCode 会话，都可以在 Codex Top 中实时打开。",
                        ...
                        "tuisBody": "在原生终端 UI 中运行 Claude Code、Codex 或 OpenCode。Codex Top 会捕获它，并同步到每台设备。",
                    ...
                    "mcp": {
                        ...
                        "wideTitle": "一个配置。\n所有 provider。",
                        "body": "在 Codex Top 中定义一次 MCP，它们即可跨所有 backend 工作，甚至包括不原生支持 MCP 的 backend。管理 skills、prompts 等等！",
                        "alt": "共享 MCP 配置的抽象占位图。"
                    },
                    "queue": {
  ...
  terminal: {
    ...
    terminalRequestDescription:
      "有终端正在请求连接到您的 Codex Top 账户。这将允许终端安全地发送和接收消息。",
  ...
  modals: {
    ...
    microphoneAccessRequiredRequestPermission:
      "Codex Top 需要访问你的麦克风用于语音聊天。出现提示时请授予权限。",
    microphoneAccessRequiredEnableInSettings:
      "Codex Top 需要访问你的麦克风用于语音聊天。请在设备设置中启用麦克风权限。",
  ...
  welcome: {
    ...
    welcomeQuestionBody: "Codex Top 是你的 AI 编码代理控制中心。无需电子邮件。你的账户是一把在本设备上生成的私钥。",

    welcomePrimaryButton: "第一次使用 — 开始吧",
    welcomePrimarySubtitle: "一次点击。无需表单。你的密钥就在这里。",

    welcomeSecondaryButton: "登录 — 我已在使用 Codex Top",
    ...
    brandHeroGetStarted: "开始",
      ...
      sessionGettingStarted: {
          phoneTitle: "尚未连接电脑",
          phoneSubtitle: "电脑连接功能正在完善，完成后可在这里查看电脑上的会话。",
        ...
        manualDisclosure: {
          ...
          steps: {
              ...
              daemonInstall: {
                  ...
                  description: '让 Codex Top 在后台保持就绪，以便远程启动。',
  ...
  setupSurface: {
    ...
    stagePrepareStatus: '正在这台电脑上准备 Codex Top 命令行。',
    ...
    blockedCliOutdatedStatus: '这台电脑上的 Codex Top 命令行版本低于设置所需的版本。请更新 Codex Top 后再试一次。',
    blockedCliUnresponsiveStatus: 'Codex Top 命令行停止响应。',
    blockedCliUnavailableStatus: 'Codex Top 无法在这台电脑上启动命令行。没有做任何更改。',
    blockedCliFailedStatus: 'Codex Top 没能读完这台电脑的设置。',
    ...
    consentBodyFallback: '这台电脑上已经有一个不由本应用管理的 Codex Top 后台服务。',
    ...
    /** 按当前语言生成 Codex Top 文案，并保留传入的动态信息。 */
    cliTrustBody: ({ command }: { command: string }) => `${command} 处的命令行不是 Codex Top 安装的。批准后它可以读写此账户的会话。请仅批准你自己放在那里的程序。`,
    cliTrustBodyUnknownCommand: '此命令行不是 Codex Top 安装的。批准后它可以读写此账户的会话。请仅批准你自己放在那里的程序。',
    cliTrustApprove: '批准',
  },
  ...
  setupOnboarding: {
          ...
          preAuthContinueHint: '继续后，Codex Top 会带你返回到针对所选 Relay 的登录流程，然后再回到这里完成设置。',
  ...
  review: {
    ...
    installables: {
      screenTitle: "可安装项",
      aboutGroupTitle: "关于",
      aboutSubtitle: "管理 Codex Top 可在此设备上安装并保持最新的工具。",
      ...
      autoUpdatePromptBody: "选择 Codex Top 应如何处理此可安装项的更新。",
      autoUpdateModes: {
        off: "关闭",
        notify: "通知",
        auto: "自动",
    ...
    cliPath: {
      title: "终端",
      footer: "Codex Top 桌面版 只会添加或移除它自己创建的 PATH 条目；由 shell 安装脚本写入的条目保持不变。",
      addTitle: "将 happier 添加到 PATH",
      addSubtitle: "让 happier 命令在新终端中可用。",
      removeTitle: "从 PATH 中移除 happier",
      removeSubtitle: "仅移除 Codex Top 桌面版 添加的 PATH 条目。",
      added: "已添加。打开新终端即可使用 happier。",
      alreadyPresent: "happier 已在你的 PATH 中。",
      removed: "已移除 Codex Top 桌面版 添加的 PATH 条目。",
      nothingToRemove: "Codex Top 桌面版 未添加任何 PATH 条目。",
    },
    stopDaemon: "停止守护进程",
  ...
  chatFooter: {
    ...
    directSessionDesktopReady: "可直接向此桌面会话发送文本，使用桌面当前的模型和权限设置。",
    directSessionDesktopUnknown: "暂时无法确认此桌面会话能否接收文本。请检查连接后重试。",
    directSessionDesktopUnavailable: "当前无法向此桌面会话发送文本。请检查桌面会话和连接后重试。",
    directSessionDesktopDisconnected: "桌面会话未连接。请在桌面应用中打开此会话后重试。",
    directSessionDesktopUnsupported: "当前桌面应用或平台不支持在此发送文本。请检查是否有兼容的桌面版本。",
    directSessionDraftKept: "消息未发送，草稿已保留。",
    directSessionTakeoverAvailable:
      "此直连会话可在你的机器上使用。可在 Codex Top 中接管它并在这里控制。",
    ...
    directTakeoverDialogTitle: "要在 Codex Top 中继续此直连会话吗？",
    directTakeoverDialogBody: "选择 Codex Top 应如何接管。直连将继续使用提供方的会话记录。导入会将记录带入 Codex Top。",
    directTakeoverDialogDirectTitle: "接管",
    directTakeoverDialogDirectBody: "在 Codex Top 中控制此会话，而不将会话记录导入 Codex Top。",
    directTakeoverDialogPersistTitle: "接管并导入",
    directTakeoverDialogPersistBody: "将会话记录导入 Codex Top，并继续使用完整的 Codex Top 会话功能。",
    directTakeoverDialogForceStopTitle: "先尝试停止本地进程",
    directTakeoverDialogForceStopBody: "Codex Top 找到了此会话对应的可信本地进程。如果你希望 Codex Top 在接管前先停止它，请启用此项。",
    directTakeoverForceStopConfirmTitle: "先停止本地进程？",
    directTakeoverForceStopConfirmBody: "Codex Top 找到了此直连会话对应的可信本地进程。要在这里接管前先停止它吗？",
  ...
  profiles: {
    ...
    defaultStorage: {
      title: "默认会话类型",
      footer: "当选择此配置文件时，为新会话覆盖账号级默认的 Codex Top/直连会话类型。",
