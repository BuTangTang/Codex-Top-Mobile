...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        openSourceMaterials: "Materials del projecte de codi obert",
        accountAndConnection: "Compte i connexió",
        moreSettings: "Més configuració",
        ...
        aboutFooter: "Codex Top es basa en el projecte de codi obert Happier.",
        whatsNew: 'Novetats',
...
deps: {
  ...
  newSession: {
      launchSettings: "Configuració d’inici",
    ...
    phonePasswordLogin: {
        title: "Inicia sessió a Codex Top",
        username: "Compte",
        password: "Contrasenya",
        showPassword: "Mostra la contrasenya",
        hidePassword: "Amaga la contrasenya",
        login: "Inicia sessió",
        server: "Configuració del servidor",
        invalidCredentials: "Compte o contrasenya incorrectes, o accés no disponible.",
        rateLimited: "Massa intents. Torna-ho a provar més tard.",
        unavailable: "No es pot iniciar sessió. Comprova el servidor i torna-ho a provar.",
    },
    sessionsList: {
        statusAwaitingConfirmation: "Pendent de confirmació",
        serverHeader: ({ server }: { server: string }) => `Servidor: ${server}`,
        storagePersistedTab: "Sessions al núvol",
        storageDirectTab: "Sessions de l’ordinador",
    ...
    directSessions: {
        ...
        historyUnavailable: "L’historial de la sessió no està disponible temporalment. Es conserven els missatges carregats anteriorment.",
        historyAvailabilityUnknown: "La font actual encara no ha indicat si l’historial de la sessió està disponible.",
        followNotifications: "Segueix les notificacions de la tasca",
        unfollowNotifications: "Deixa de seguir les notificacions de la tasca",
        followUpdateFailed: "No s’han pogut actualitzar les notificacions. Comprova la connexió i torna-ho a provar.",
        observation: {
            running: "En execució",
            needs_input: "Cal una resposta",
        ...
        browseSearchIncomplete: "La cerca no ha inclòs totes les sessions; pot haver-hi més coincidències. Prova una cerca més específica.",
...
settingsSession: {
    ...
    settingsLanguage: {
        saveFailed: "No s’ha pogut desar la configuració de l’idioma. Torna-ho a provar.",
    ...
    welcome: {
        ...
        welcomeQuestionBody: 'Codex Top és el centre de control dels teus agents de codificació amb IA. No cal correu electrònic. El teu compte és una clau privada, generada en aquest dispositiu.',

        welcomePrimaryButton: 'Primera vegada aquí — comencem',
        welcomePrimarySubtitle: 'Un toc. Sense formulari. La teva clau viu aquí.',

        welcomeSecondaryButton: 'Inicia sessió — ja faig servir Codex Top',
    ...
    sessionGettingStarted: {
        phoneTitle: "Cap ordinador connectat",
        phoneSubtitle: "Estem millorant la connexió amb ordinadors. Les sessions apareixeran aquí després de connectar.",
        title: {
    ...
    message: {
      ...
      chatFooter: {
        ...
        directSessionDesktopReady: "Pots enviar text directament a aquesta sessió d’escriptori. S’utilitzaran el model i els permisos actuals de l’escriptori.",
        directSessionDesktopUnknown: "No es pot confirmar si aquesta sessió d’escriptori pot rebre text. Comprova la connexió i torna-ho a provar.",
        directSessionDesktopUnavailable: "L’enviament de text a aquesta sessió d’escriptori no està disponible. Comprova la sessió i la connexió i torna-ho a provar.",
        directSessionDesktopDisconnected: "La sessió d’escriptori no està connectada. Obre aquesta sessió a l’aplicació d’escriptori i torna-ho a provar.",
        directSessionDesktopUnsupported: "Aquesta aplicació o plataforma d’escriptori no admet l’enviament de text des d’aquí. Comprova si hi ha una versió d’escriptori compatible.",
        directSessionDraftKept: "El missatge no s’ha enviat. L’esborrany s’ha conservat.",
