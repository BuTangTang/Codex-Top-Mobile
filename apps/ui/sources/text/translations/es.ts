...
export const es: TranslationStructure = {
    codexTopProjects: {
        ...
        unavailable: 'Desktop projects are unavailable',
        offline: 'This computer is offline. Connect it to read projects.',
        empty: 'This computer has no projects',
        refresh: 'Refresh projects',
        openSessions: 'View conversations in this project',
        missing: 'This project is no longer available. Select another project.',
        selectMachine: 'Choose one computer to filter by project.',
        partial: 'Some project sources are unavailable. Refresh or check the computer.',
        unavailableFolder: 'The project folder is currently unavailable',
        unknownCodex: 'Open a conversation to check Codex controls',
        codex: 'Codex status',
    },
  ...
  settings: {
    ...
    openSourceMaterials: "Material del proyecto de código abierto",
    accountAndConnection: "Cuenta y conexión",
    ...
    aboutFooter:
      "Codex Top se basa en el proyecto de código abierto Happier.",
    whatsNew: "Novedades",
  ...
  newSession: {
      launchSettings: "Ajustes de inicio",
  ...
  phonePasswordLogin: {
      title: "Iniciar sesión en Codex Top",
      username: "Cuenta",
      password: "Contraseña",
      ...
      invalidCredentials: "Cuenta o contraseña incorrecta, o acceso no disponible.",
      rateLimited: "Demasiados intentos. Inténtalo más tarde.",
      unavailable: "No se puede iniciar sesión. Revisa el servidor e inténtalo de nuevo.",
  },
  sessionsList: {
      statusAwaitingConfirmation: "Pendiente de confirmación",
    serverHeader: ({ server }: { server: string }) => `Servidor: ${server}`,
    storagePersistedTab: "Sesiones en la nube",
    storageDirectTab: "Sesiones del equipo",
  ...
  directSessions: {
    ...
    browseListChanged: "La lista de sesiones ha cambiado. Actualízala para seguir cargando.",
    browseListIncomplete: "Esta lista aún no incluye todas las sesiones. Puede haber más sesiones disponibles. Actualiza la lista e inténtalo de nuevo más tarde.",
    historyPreviewOnly: "Solo hay una vista previa disponible. No se puede leer el historial completo de la sesión desde la fuente actual.",
    historyUnavailable: "El historial de la sesión no está disponible temporalmente. Se conservan los mensajes ya cargados.",
    historyAvailabilityUnknown: "La fuente actual aún no ha indicado si el historial de la sesión está disponible.",
        followNotifications: "Seguir las notificaciones de la tarea",
        unfollowNotifications: "Dejar de seguir las notificaciones de la tarea",
        followUpdateFailed: "No se pudieron actualizar las notificaciones. Comprueba la conexión e inténtalo de nuevo.",
        observation: {
            running: "En curso",
            needs_input: "Requiere tu respuesta",
    ...
    browseActivityUnknown: "Desconocida",
        ...
        browseSearchIncomplete: "La búsqueda no abarcó todas las sesiones; puede haber más coincidencias. Prueba una búsqueda más específica.",
...
settingsSession: {
  ...
  settingsLanguage: {
        saveFailed: "No se pudo guardar el idioma. Inténtalo de nuevo.",
  ...
  welcome: {
    ...
    welcomeQuestionBody: "Codex Top es el centro de control de tus agentes de codificación con IA. No hace falta correo electrónico. Tu cuenta es una clave privada que se genera en este dispositivo.",

    welcomePrimaryButton: "Primera vez aquí — empecemos",
    welcomePrimarySubtitle: "Un toque. Sin formulario. Tu clave vive aquí.",

    welcomeSecondaryButton: "Iniciar sesión — ya uso Codex Top",
    ...
    brandHeroGetStarted: "Empezar",
      ...
      sessionGettingStarted: {
          phoneTitle: "Ningún equipo conectado",
          phoneSubtitle: "Estamos mejorando la conexión con equipos. Tras conectarte, las sesiones aparecerán aquí.",
  ...
  chatFooter: {
    ...
    directSessionDesktopReady: "Puedes enviar texto directamente a esta sesión de escritorio. Se usarán el modelo y los permisos actuales del escritorio.",
    directSessionDesktopUnknown: "No se puede confirmar si esta sesión de escritorio puede recibir texto. Comprueba la conexión e inténtalo de nuevo.",
    directSessionDesktopUnavailable: "No está disponible el envío de texto a esta sesión de escritorio. Comprueba la sesión y la conexión e inténtalo de nuevo.",
    directSessionDesktopDisconnected: "La sesión de escritorio no está conectada. Abre esta sesión en la aplicación de escritorio e inténtalo de nuevo.",
    directSessionDesktopUnsupported: "Esta aplicación o plataforma de escritorio no admite el envío de texto desde aquí. Comprueba si hay una versión de escritorio compatible.",
    directSessionDraftKept: "No se ha enviado tu mensaje. Se ha conservado tu borrador.",
