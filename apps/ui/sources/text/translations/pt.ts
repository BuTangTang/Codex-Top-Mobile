...
export const pt: TranslationStructure = {
  ...
  settings: {
    ...
    // Main settings hub category groups
      ...
      openSourceMaterials: "Materiais do projeto de código aberto",
      accountAndConnection: "Conta e conexão",
    ...
    aboutFooter:
      "O Codex Top é baseado no projeto de código aberto Happier.",
    whatsNew: "Novidades",
  ...
  newSession: {
      launchSettings: "Configurações de início",
  ...
  phonePasswordLogin: {
      ...
      invalidCredentials: "Conta ou senha incorreta, ou acesso indisponível.",
      rateLimited: "Muitas tentativas. Tente novamente mais tarde.",
      unavailable: "Não foi possível entrar. Verifique o servidor e tente novamente.",
  },
  sessionsList: {
      statusAwaitingConfirmation: "Aguardando confirmação",
    serverHeader: ({ server }: { server: string }) => `Servidor: ${server}`,
    storagePersistedTab: "Sessões na nuvem",
    storageDirectTab: "Sessões no computador",
  ...
  directSessions: {
    browseListChanged: "A lista de sessões mudou. Atualize-a para continuar carregando.",
    browseListIncomplete: "Esta lista ainda não inclui todas as sessões. Pode haver outras sessões disponíveis. Atualize a lista e tente novamente mais tarde.",
    historyPreviewOnly: "Apenas uma prévia está disponível. Não é possível ler o histórico completo da sessão a partir da fonte atual.",
    historyUnavailable: "O histórico da sessão está temporariamente indisponível. As mensagens já carregadas são mantidas.",
    historyAvailabilityUnknown: "A fonte atual ainda não informou se o histórico da sessão está disponível.",
        followNotifications: "Acompanhar notificações da tarefa",
        unfollowNotifications: "Deixar de acompanhar notificações da tarefa",
        followUpdateFailed: "Não foi possível atualizar as notificações. Verifique a conexão e tente novamente.",
        observation: {
            running: "Em execução",
    ...
    browseActivityUnknown: "Desconhecida",
        ...
        browseSearchIncomplete: "A pesquisa não abrangeu todas as sessões; podem existir mais resultados correspondentes. Tente uma pesquisa mais específica.",
...
settingsSession: {
  ...
  settingsLanguage: {
        saveFailed: "Não foi possível salvar o idioma. Tente novamente.",
  ...
  welcome: {
    ...
    welcomeQuestionBody: "Codex Top é o centro de controle dos seus agentes de programação com IA. Sem precisar de e-mail. Sua conta é uma chave privada, gerada neste dispositivo.",

    welcomePrimaryButton: "Primeira vez aqui — vamos começar",
    welcomePrimarySubtitle: "Um toque. Sem formulário. Sua chave vive aqui.",

    welcomeSecondaryButton: "Entrar — já uso o Codex Top",
    ...
    brandHeroGetStarted: "Começar",
      ...
      sessionGettingStarted: {
          phoneTitle: "Nenhum computador conectado",
          phoneSubtitle: "Estamos melhorando a conexão com computadores. As sessões aparecerão aqui após a conexão.",
  ...
  chatFooter: {
    ...
    directSessionDesktopReady: "Você pode enviar texto diretamente para esta sessão de desktop. Serão usados o modelo e as permissões atuais do desktop.",
    directSessionDesktopUnknown: "Não foi possível confirmar se esta sessão de desktop pode receber texto. Verifique a conexão e tente novamente.",
    directSessionDesktopUnavailable: "O envio de texto para esta sessão de desktop está indisponível. Verifique a sessão e a conexão e tente novamente.",
    directSessionDesktopDisconnected: "A sessão de desktop não está conectada. Abra esta sessão no aplicativo de desktop e tente novamente.",
    directSessionDesktopUnsupported: "Este aplicativo ou plataforma de desktop não permite enviar texto por aqui. Verifique se há uma versão de desktop compatível.",
    directSessionDraftKept: "Sua mensagem não foi enviada. Seu rascunho foi mantido.",
