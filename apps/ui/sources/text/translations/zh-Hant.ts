...
const zhHantOverrides: DeepPartial<TranslationStructure> = {
  ...
  settings: {
        ...
        openSourceMaterials: "開源專案資料",
        accountAndConnection: "帳號與連線",
        moreSettings: "更多設定",
        ...
        aboutFooter: "Codex Top 基於 Happier 開源專案開發。",
        whatsNew: '更新日誌',
  ...
  newSession: {
    ...
    phonePasswordLogin: {
        ...
        login: "登入",
        server: "伺服器設定",
        invalidCredentials: "帳號或密碼不正確，或帳號暫不可用。",
        rateLimited: "嘗試次數過多，請稍後重試。",
        unavailable: "登入失敗，請檢查伺服器後重試。",
    },
    sessionsList: {
        statusAwaitingConfirmation: "待確認",
        serverHeader: ({ server }: { server: string }) => `伺服器：${server}`,
        storagePersistedTab: "雲端會話",
        storageDirectTab: "電腦會話",
    ...
    directSessions: {
        ...
        historyUnavailable: "暫時無法讀取對話歷程，已載入的訊息仍會保留。",
        historyAvailabilityUnknown: "目前來源尚未提供歷程記錄的可用狀態。",
    followNotifications: "關注任務通知",
    unfollowNotifications: "取消任務通知",
    followUpdateFailed: "無法更新任務通知，請檢查連線後重試。",
    observation: {
        running: "執行中",
        needs_input: "等待處理",
        completed: "已完成",
        ...
        browseSearchIncomplete: "搜尋尚未涵蓋所有工作階段，可能還有符合的結果。請縮小搜尋範圍後重試。",
...
settingsSession: {
    ...
    welcome: {
        ...
        welcomeQuestionBody: 'Codex Top 是你 AI 編碼代理的控制中心。無需電子郵件。你的帳戶是一把在本裝置上產生的私鑰。',

        welcomePrimaryButton: '第一次使用 — 開始吧',
        welcomePrimarySubtitle: '一次點擊。無需表單。你的金鑰就在這裡。',

        welcomeSecondaryButton: '登入 — 我已在使用 Codex Top',
        ...
        sessionGettingStarted: {
            phoneTitle: "尚未連接電腦",
            phoneSubtitle: "電腦連線功能正在完善，完成後可在這裡查看電腦上的會話。",
    ...
    chatFooter: {
        ...
        directSessionDesktopReady: "可直接向此桌面工作階段傳送文字，使用桌面目前的模型和權限設定。",
        directSessionDesktopUnknown: "暫時無法確認此桌面工作階段能否接收文字。請檢查連線後重試。",
        directSessionDesktopUnavailable: "目前無法向此桌面工作階段傳送文字。請檢查桌面工作階段和連線後重試。",
        directSessionDesktopDisconnected: "桌面工作階段未連線。請在桌面應用程式中開啟此工作階段後重試。",
        directSessionDesktopUnsupported: "目前的桌面應用程式或平台不支援在此傳送文字。請檢查是否有相容的桌面版本。",
        directSessionDraftKept: "訊息未傳送，草稿已保留。",
