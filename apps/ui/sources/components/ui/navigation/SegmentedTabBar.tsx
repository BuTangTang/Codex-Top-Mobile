...
const stylesheet = StyleSheet.create((theme) => ({
    ...
    underlineActive: { borderBottomColor: theme.colors.accent.blue },
    underlineLabelActive: { color: theme.colors.accent.blue },
    innerCompact: {
        borderRadius: 7,
    },
    tab: {
...
function SegmentedTabBarInner<T extends string>(props: SegmentedTabBarProps<T>) {
    ...
    return (
        <View style={styles.container}>
            <View
                style={[styles.inner, compact ? styles.innerCompact : null, underline ? styles.underlineTrack : null]}
            ...
            >
                {props.tabs.map((tab, tabIndex) => {
                    ...
                    const content = iconOnly ? (
                        ...
                        <Text style={[styles.tabLabel, compact ? styles.tabLabelCompact : null, active ? styles.tabLabelActive : null, underline && active ? styles.underlineLabelActive : null]}>{tab.label}</Text>
                    );
                    return (
                        <Pressable
                            key={tab.id}
                            ...
                            style={[
                                ...
                                active && !underline ? styles.tabActive : null,
                                underline ? styles.underlineTab : null,
                                underline && active ? styles.underlineActive : null,
