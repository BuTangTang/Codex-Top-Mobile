...
const deviceTypeState = vi.hoisted(() => ({ value: 'desktop' }));
vi.mock('@/utils/platform/responsive', () => ({ useDeviceType: () => deviceTypeState.value }));
...
describe('NotificationsSettingsView', () => {
    ...
    it('keeps phone notification controls focused on delivery instead of developer webhook settings', async () => {
        ...
        expect(screen.findRow('settings-notifications-add-webhook')).toBeFalsy();
        expect(screen.findRow('settings-notifications-badges-enabled')).toBeFalsy();
        expect(screen.findRowByTitle('settingsNotifications.local.readyTitle')).toBeNull();
        expect(screen.findRowByTitle('settingsNotifications.types.readyPreview.title')).toBeNull();
        expect(screen.findRowByTitle('settingsNotifications.types.requestPreview.title')).toBeNull();
