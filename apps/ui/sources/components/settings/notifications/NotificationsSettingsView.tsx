...
/** 手机聚焦接收提醒与提醒类型，桌面保留 webhook 等管理功能；不改写已有通知配置。 */
export const NotificationsSettingsView = React.memo(function NotificationsSettingsView() {
    const { theme } = useUnistyles();
    const isPhone = useDeviceType() === 'phone';
    const [foregroundMenuOpen, setForegroundMenuOpen] = React.useState(false);
    const iconSize = isPhone ? 22 : 29;
    ...
    return (
        <ItemList style={{ paddingTop: 0, backgroundColor: isPhone ? theme.colors.surface.base : theme.colors.background.canvas }} testID="settings-notifications-screen">
            {!isPhone ? (
            <SettingsSection compact={isPhone}
                title={t('settingsNotifications.badges.title')}
                footer={t('settingsNotifications.badges.footer')}
            >
                <Item
                    density={isPhone ? 'cozy' : undefined}
                    style={isPhone ? { minHeight: 48 } : undefined}
                    titleLines={isPhone ? 0 : undefined}
                    ...
                    icon={<Icon name="stack" size={iconSize} color={theme.colors.accent.blue} />}
                    rightElement={(
                        <Switch
                ...
                <Item
                    ...
                    icon={<Icon name="envelope-simple-open" size={iconSize} color={theme.colors.text.secondary} />}
                    rightElement={(
                        <Switch
                ...
                <Item
                    ...
                    icon={<Icon name="hand" size={iconSize} color={theme.colors.text.secondary} />}
                    rightElement={(
                        <Switch
                ...
                <Item
                    ...
                    icon={<Icon name="chat-dots" size={iconSize} color={theme.colors.text.secondary} />}
                    rightElement={(
                        <Switch
                ...
                <Item
                    ...
                    icon={<Icon name="hourglass" size={iconSize} color={theme.colors.text.secondary} />}
                    rightElement={(
                        <Switch
                ...
                <Item
                    ...
                    icon={<Icon name="users" size={iconSize} color={theme.colors.text.secondary} />}
                    rightElement={(
                        <Switch
                ...
                <Item
                    ...
                    icon={<Icon name="circle" size={iconSize} color={theme.colors.text.secondary} />}
                    rightElement={(
                        <Switch
            ...
            <SettingsSection compact={isPhone}
                ...
                footer={isPhone ? undefined : t('settingsNotifications.local.footer')}
            >
                <Item
                    density={isPhone ? 'cozy' : undefined}
                    style={isPhone ? { minHeight: 48 } : undefined}
                    ...
                    subtitle={isPhone ? undefined : t('settingsNotifications.local.enabledSubtitle')}
                    icon={<Icon name="device-mobile" size={iconSize} color={theme.colors.accent.blue} />}
                    rightElement={(
                        <Switch
                ...
                <Item
                    ...
                    icon={<Icon name="check-circle" size={iconSize} color={theme.colors.state.success.foreground} />}
                    rightElement={(
                        <Switch
                ...
                <Item
                    ...
                    icon={<Icon name="chat-circle-dots" size={iconSize} color={theme.colors.text.secondary} />}
                    rightElement={(
                        <Switch
            ...
            {isDesktopNotificationsSupported ? (
                ...
                >
                    ...
                    titleLines={isPhone ? 0 : undefined}
                        ...
                        icon={<Icon name="desktop" size={iconSize} color={desktopPermissionIconColor} />}
            ...
            <SettingsSection compact={isPhone}
                ...
                footer={isPhone ? undefined : t('settingsNotifications.push.footer')}
            >
                <Item
                    density={isPhone ? 'cozy' : undefined}
                    style={isPhone ? { minHeight: 48 } : undefined}
                    ...
                    title={t('common.enabled')}
                    subtitle={isPhone ? undefined : t('settingsNotifications.push.enabledSubtitle')}
                    icon={<Icon name="bell" size={iconSize} color={theme.colors.accent.blue} />}
                    rightElement={(
                        <Switch
                            value={pushEnabled}
                ...
                <Item
                    ...
                    subtitle={isPhone ? undefined : t('settingsNotifications.push.troubleshootSubtitle')}
                    icon={<Icon name="question" size={iconSize} color={theme.colors.text.secondary} />}
            ...
            >
                <Item
                    ...
                    icon={<Icon name="plus-circle" size={iconSize} color={theme.colors.accent.blue} />}
                ...
                {webhookChannels.length === 0 ? (
                    ...
                    titleLines={isPhone ? 0 : undefined}
                        ...
                        icon={<Icon name="link" size={iconSize} color={theme.colors.text.secondary} />}
                        showChevron={false}
                    />
                ) : (
                    ...
                    titleLines={isPhone ? 0 : undefined}
                                ...
                                icon={<Icon name="link" size={iconSize} color={theme.colors.accent.blue} />}
                                rightElement={(
                                    <ItemRowActions
                                        title={channel.url}
                    ...
                    titleLines={isPhone ? 0 : undefined}
                                ...
                                icon={<Icon name="bell" size={iconSize} color={theme.colors.text.secondary} />}
                                rightElement={(
                                    <Switch
                    ...
                    titleLines={isPhone ? 0 : undefined}
                                ...
                                icon={<Icon name="key" size={iconSize} color={theme.colors.text.secondary} />}
                    ...
                    titleLines={isPhone ? 0 : undefined}
                                ...
                                showChevron={false}
                            />
                            {!isPhone && showConnectedServiceNotificationTopics ? (
                                <>
                    ...
                    titleLines={isPhone ? 0 : undefined}
                                            ...
                                            icon={<Icon name="arrows-left-right" size={iconSize} color={theme.colors.text.secondary} />}
                                            rightElement={(
                                                <Switch
                    ...
                    titleLines={isPhone ? 0 : undefined}
                                                ...
                                                icon={<Icon name="timer" size={iconSize} color={theme.colors.text.secondary} />}
                                                rightElement={(
                                                    <Switch
                    ...
                    titleLines={isPhone ? 0 : undefined}
                                                ...
                                                icon={<Icon name="check-circle" size={iconSize} color={theme.colors.text.secondary} />}
                                                rightElement={(
                                                    <Switch
            ...
            <SettingsSection compact={isPhone}
                ...
                footer={isPhone ? undefined : t('settingsNotifications.types.footer')}
            >
                <Item
                    density={isPhone ? 'cozy' : undefined}
                    style={isPhone ? { minHeight: 48 } : undefined}
                    ...
                    subtitle={isPhone ? undefined : t('settingsNotifications.types.ready.subtitle')}
                    icon={<Icon name="check-circle" size={iconSize} color={theme.colors.state.success.foreground} />}
                    rightElement={(
                        <Switch
                ...
                <Item
                    ...
                    subtitle={isPhone ? undefined : t('settingsNotifications.types.permissionRequests.subtitle')}
                    icon={<Icon name="hand" size={iconSize} color={theme.colors.text.secondary} />}
                    rightElement={(
                        <Switch
                ...
                <Item
                    ...
                    subtitle={isPhone ? undefined : t('settingsNotifications.types.userActions.subtitle')}
                    icon={<Icon name="chat-dots" size={iconSize} color={theme.colors.text.secondary} />}
                    rightElement={(
                        <Switch
            ...
            {isPhone ? <SettingsSection compact={isPhone}>
                <DropdownMenu
                    open={foregroundMenuOpen}
                    onOpenChange={setForegroundMenuOpen}
                    selectedId={localSettings.localNotificationsForegroundBehavior}
                    items={(['full', 'silent', 'off'] as const).map((id) => ({ id, title: t(`settingsNotifications.foregroundBehavior.${id}`) }))}
                    onSelect={(id) => {
                        // 沿用已有真实偏好 setter，选择只改变前台提醒方式。
                        if (id === 'full' || id === 'silent' || id === 'off') setLocalSetting({ localNotificationsForegroundBehavior: id });
                        setForegroundMenuOpen(false);
                    }}
                    variant="selectable"
                    rowKind="item"
                    itemTrigger={{ title: t('settingsNotifications.foregroundBehavior.title'), showSelectedDetail: true, itemProps: { testID: 'settings-notifications-phone-foreground', density: 'cozy' } }}
                />
            </SettingsSection> : (
            <SettingsSection compact={isPhone}
            ...
            >
                <Item
                    ...
                    icon={<Icon name="speaker-high" size={iconSize} color={theme.colors.accent.blue} />}
                ...
                <Item
                    ...
                    icon={<Icon name="speaker-slash" size={iconSize} color={theme.colors.accent.blue} />}
                ...
                <Item
                    ...
                    icon={<Icon name="bell-slash" size={iconSize} color={theme.colors.accent.blue} />}
