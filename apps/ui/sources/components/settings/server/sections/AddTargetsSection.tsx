...
export function AddTargetsSection(props: AddTargetsSectionProps) {
    ...
    return (
        <SettingsSection compact={props.compact} title={t('server.addTargetsTitle')}>
            <Item
            ...
            {expanded === 'server' ? (
                <View style={styles.contentContainer}>
                    ...
                    {props.autoMode || props.compact ? null : (
                        <>
                    ...
                    <View style={styles.buttonRow}>
                        {!props.compact ? <View style={styles.buttonWrapper}>
                            <RoundButton
