...
const stylesheet = StyleSheet.create((theme, runtime) => ({
    ...
    phoneComposerInput: { backgroundColor: theme.colors.input.background, borderRadius: 8, minHeight: 48 },
    phoneSessionPanel: {
        borderRadius: 0,
        borderWidth: 0,
...
/** 复用草稿与发送流程，仅为已有手机会话应用紧凑输入样式。 */
export const AgentInput = React.memo(React.forwardRef<MultiTextInputHandle, AgentInputProps>((props, ref) => {
    // 已有手机会话采用紧凑输入外观，新建会话和大屏保留原布局。
    ...
    /** 保留同一原生输入实例和草稿接口，仅在手机上加紧凑输入底色。 */
    const renderComposerInput = () => (
        <View
            ref={composerAnchorRef}
            collapsable={false}
            testID="agent-input-composer-input-container"
            style={[styles.inputContainer, isPhoneSession ? styles.phoneComposerInput : null, props.minHeight ? { minHeight: props.minHeight } : undefined]}
            onLayout={(event) => {
        ...
        <View style={styles.actionButtonsContainer}>
            ...
            >{[
                ...
                >
                    ...
                    {isPhoneSession ? null : renderSubmitButton()}
                </View>,
    ...
    const renderActionFooterSection = () => (
        ...
        >
            {isPhoneSession ? null : renderActionRows()}
        </View>
    );
    ...
    return (
        <SyncPerformanceReactProfiler id="sessions.agentInput">
            <View
                ...
                style={[
                    styles.container,
                    isPhoneSession ? styles.phoneSessionContainer : null,
            ...
            >
                ...
                <View style={[styles.panelShadow, isGlassComposer && !isPhoneSession ? styles.panelShadowGlass : null]}>
                <WebDropTargetView
                    testID="agent-input-drop-zone"
                    style={[
                        styles.unifiedPanel,
                        isGlassComposer ? styles.unifiedPanelGlass : null,
                        isPhoneSession ? styles.phoneSessionPanel : null,
                        props.panelStyle,
                            ...
                            <View style={isPhoneSession ? styles.phoneComposerRow : undefined}>
                                ...
                                <View
                                    style={[
                                        styles.nativeKeyboardVariableSection,
                                        styles.nativeKeyboardVariableSectionContent,
                                        isPhoneSession ? styles.phoneComposerVariableSection : null,
                                        typeof panelVariableSectionMaxHeight === 'number'
                                            ? { maxHeight: panelVariableSectionMaxHeight }
                                            : null,
                                    ]}
                                ...
                                {isPhoneSession ? renderSubmitButton() : null}
                            </View>
                            {renderActionFooterSection()}
                        </View>
                    )}
