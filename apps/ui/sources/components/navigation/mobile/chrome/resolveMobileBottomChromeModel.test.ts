...
describe('resolveMobileBottomChromeModel', () => {
    it('classifies computers before the containing settings subtree', () => {
        expect(resolveMobileBottomChromeModel(createChromeInput({ pathname: '/settings/machines' }))).toEqual({
            kind: 'mainAppTabs', activeTab: 'machines',
        });
    });
