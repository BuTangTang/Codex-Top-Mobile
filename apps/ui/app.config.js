...
const { resolveCodexTopRouterRoot } = require('./sources/dev/codexTopPreview/resolveCodexTopRouterRoot.cjs');
// 插件 root 与 extra.router.root 必须使用同一次解析。开关关闭、非 development 或 production 运行时都保持正式 sources/app。
const codexTopLogicalVariant = appVariantOverride || appEnvironmentConfig.logicalVariant;
const codexTopRouterRoot = resolveCodexTopRouterRoot({
    previewSwitch: process.env.EXPO_PUBLIC_CODEX_TOP_PREVIEW,
    logicalVariant: codexTopLogicalVariant,
    devRuntime: process.env.NODE_ENV !== 'production',
});
...
const baseExpoConfig = {
        ...
        orientation: "default",
        icon: "./sources/assets/images/codex-top.png",
        ...
        android: {
            adaptiveIcon: {
                foregroundImage: "./sources/assets/images/codex-top.png",
                // 原版彩色图不作为单色蒙版，保留普通彩色应用图标。
        ...
        plugins: [
            ...
            [
                'expo-splash-screen',
                {
                    ...
                    android: {
                        image: "./sources/assets/images/codex-top.png",
